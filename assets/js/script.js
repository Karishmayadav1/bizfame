(function($) {
	...
	// HM4 Testimonial Carousel
	if ($('.hm4-testimonial-carousel').length) {
		$('.hm4-testimonial-carousel').owlCarousel({
			loop:true,
			margin:30,
			nav:true,
			smartSpeed: 500,
	...
	// HM5 Testimonial Carousel
	if ($('.hm5-testimonial-carousel').length) {
		$('.hm5-testimonial-carousel').owlCarousel({
			loop:true,
			margin:30,
			nav:true,
			smartSpeed: 500,
